      ...
      <div class="flex h-screen justify-center items-center">
        ...
        <div class="justify-center items-center inline-flex z-20">
          ...
          >
            ...
            <div
              class="text-center text-text-secondary text-base max-w-md font-normal leading-normal"
            >
    ...
    >
      ...
      >
        <path
          ...
          stroke="url(#paint0_linear_23_634)"
          stroke-width="2"
        />
        <defs>
          <linearGradient
            id="paint0_linear_23_634"
            x1="-13"
            y1="8"
            x2="25.5"
            y2="34.5"
      ...
      >
        <path
          d="M20 3.23607L23.5392 14.1287L23.7637 14.8197H24.4903H35.9434L26.6776 21.5517L26.0899 21.9787L26.3144 22.6697L29.8536 33.5623L20.5878 26.8303L20 26.4033L19.4122 26.8303L10.1464 33.5623L13.6856 22.6697L13.9101 21.9787L13.3224 21.5517L4.05655 14.8197H15.5097H16.2363L16.4608 14.1287L20 3.23607Z"
          stroke="url(#paint0_linear_23_635)"
          stroke-width="2"
        />
        <defs>
          <linearGradient
            id="paint0_linear_23_635"
            x1="65"
            y1="35"
            x2="13"
            y2="-14"
      ...
      >
        <path
          d="M20 3.23607L23.5392 14.1287L23.7637 14.8197H24.4903H35.9434L26.6776 21.5517L26.0899 21.9787L26.3144 22.6697L29.8536 33.5623L20.5878 26.8303L20 26.4033L19.4122 26.8303L10.1464 33.5623L13.6856 22.6697L13.9101 21.9787L13.3224 21.5517L4.05655 14.8197H15.5097H16.2363L16.4608 14.1287L20 3.23607Z"
          stroke="url(#paint0_linear_23_636)"
          stroke-width="2"
        />
        <defs>
          <linearGradient
            id="paint0_linear_23_636"
            x1="25.5"
            y1="70"
            x2="9.5"
            y2="11.5"
      ...
      <div>
        <div class="flex justify-center items-center h-screen">
          ...
          >
            ...
            <div
              class="text-justify md:text-center text-text-secondary text-base font-medium max-w-5xl"
            >
